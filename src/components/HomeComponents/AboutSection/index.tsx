      ...
      <Container>
        <div className="grid grid-cols-2 gap-4 items-start">
          ...
          <div className="flex flex-col  gap-5 text-black text-md text-justify">
            <p>
              <span className="text-5xl">N</span>a certidão, Grace Natividade.
              No coração, Grace G. Natividade — onde esse “G” carrega muito mais
              do que uma letra: é uma homenagem viva a Ana Gonçalves, sua mãe,
              sua referência, seu alicerce, sua inspiração. O sobrenome que não
              consta no papel, mas que está gravado na alma, na história e no
              legado que constrói todos os dias.
            </p>

            <p>
              E se tem algo que define Grace, é paixão por criar, planejar e
              executar eventos que fazem história. Uma mente inquieta, movida
              por desafios, alucinada por detalhes, tendências, inovação e,
              acima de tudo, resultados. Uma mulher que respira planejamento,
              mas vive para realizar — e que acredita que eventos são mais do
              que encontros; são experiências capazes de gerar conexão,
              transformação e impacto real.
            </p>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4 items-center">
          <div className="flex flex-col  gap-5 text-black text-justify">
            <p>
              ...
              estética; onde veem um palco, ela vê narrativa; onde muitos veem
              um coffee break, ela vê uma oportunidade de encantar, surpreender
              e gerar memória afetiva.
            </p>
            <p>
              ...
              essencial quanto saber desenhar um projeto de cenografia
              impecável. Carrega também a chancela de Claudia Matarazzo,
              referência nacional em etiqueta, protocolo e cerimonial, com quem
              se especializou em Cerimonial e Planejamento de Eventos.
            </p>
          </div>
          <div className="h-full w-full bg-neutral-400 rounded overflow-hidden">
            <Image
